...
<body>
    <div class="container">
        ...
        <div class="judul-dokumen">
            ...
            <div>Tahun Ajaran {{ date('Y') }}/{{ date('Y')+1 }}</div>
        </div>
        ...
        <!-- Status Pendaftaran -->
        <div class="status-box status-{{ strtolower($pendaftaran->status) }}">
        ...
        <div class="footer">
            ...
            <div>Halaman: 1/1</div>
            <div>Validasi: {{ strtoupper(md5($pendaftaran->id . $pendaftaran->no_pendaftaran . date('Ymd'))) }}</div>
        </div>
    </div>
