...
@section('title', 'Status Pendaftaran - MA Plus Al Asyariyah')
            ...
            <div class="px-8 py-10">
                ...
                <div class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-6 mb-8 text-center border-2 border-primary-200">
                    ...
                    <p class="font-display text-3xl font-bold text-primary-600">
                        {{ $pendaftaran->no_pendaftaran ?? $pendaftaran->nomor_pendaftaran }}
                    </p>
                </div>
                    ...
                    <div class="{{ $statusBoxClasses }}">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                @endphp
                                <p class="{{ $statusTextClasses }}">
                                    Status: <span class="uppercase">{{ $pendaftaran->status }}</span>
                                </p>
                                ...
                                @if($pendaftaran->keterangan && $pendaftaran->status != 'ditolak')
                                    <p class="text-sm text-gray-700 mt-2">
                                        <strong>Catatan:</strong> {{ $pendaftaran->keterangan }}
                                    </p>
                                @endif
                            </div>
                        </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-4">
                    <a href="{{ route('pendaftaran.cek-status') }}" class="flex-1 bg-gradient-to-r from-primary-600 to-primary-700 text-white px-8 py-4 rounded-lg font-bold text-center hover:from-primary-700 hover:to-primary-800 transition-all duration-300 shadow-lg hover:shadow-xl">
                        Cek Status Lagi
                    </a>
                    <a href="{{ route('home') }}" class="flex-1 bg-white text-primary-600 px-8 py-4 rounded-lg font-bold text-center border-2 border-primary-600 hover:bg-primary-50 transition-all duration-300">
                        Kembali ke Beranda
                    </a>
                </div>
