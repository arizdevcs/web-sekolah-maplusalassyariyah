...
@section('title', 'Pendaftaran Berhasil - MA Plus Al Asyariyah')
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
            ...
            <div class="bg-gray-50 rounded-xl p-6 mb-8 text-left">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900">{{ $pendaftaran->tempat_lahir }}, {{ $pendaftaran->tanggal_lahir_format }}</p>
                    </div>
                    <div>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="{{ route('pendaftaran.cek-status') }}" class="flex-1 bg-gradient-to-r from-primary-600 to-primary-700 text-white px-8 py-4 rounded-lg font-bold hover:from-primary-700 hover:to-primary-800 transition-all duration-300 shadow-lg hover:shadow-xl">
                    Cek Status Pendaftaran
                </a>
                <a href="{{ route('home') }}" class="flex-1 bg-white text-primary-600 px-8 py-4 rounded-lg font-bold border-2 border-primary-600 hover:bg-primary-50 transition-all duration-300">
                    Kembali ke Beranda
                </a>
            </div>
