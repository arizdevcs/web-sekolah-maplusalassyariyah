...
<section class="py-16 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <form action="<?php echo e(route('pendaftaran.store')); ?>" method="POST" class="space-y-8">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required class="input-field" placeholder="Masukkan nama lengkap sesuai ijazah">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir')); ?>" required class="input-field" placeholder="Kota/Kabupaten">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Tanggal Lahir <span class="text-red-500">*</span></label>
                            <input type="date" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" required class="input-field">
                        </div>
                        
                        <div class="md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Alamat Lengkap <span class="text-red-500">*</span></label>
                            <textarea name="alamat" required class="input-field" rows="3" placeholder="Jalan, RT/RW, Kelurahan, Kecamatan, Kota"><?php echo e(old('alamat')); ?></textarea>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Nomor Telepon/WA <span class="text-red-500">*</span></label>
                            <input type="tel" name="nomor_telepon" value="<?php echo e(old('nomor_telepon')); ?>" required class="input-field" placeholder="08xxxxxxxxxx">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Email</label>
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="input-field" placeholder="email@example.com">
                        </div>
                        
                        <div class="md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Asal Sekolah <span class="text-red-500">*</span></label>
                            <input type="text" name="asal_sekolah" value="<?php echo e(old('asal_sekolah')); ?>" required class="input-field" placeholder="Nama SMP/MTs asal">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="nama_ayah" value="<?php echo e(old('nama_ayah')); ?>" required class="input-field" placeholder="Nama lengkap ayah">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Pekerjaan Ayah <span class="text-red-500">*</span></label>
                            <input type="text" name="pekerjaan_ayah" value="<?php echo e(old('pekerjaan_ayah')); ?>" required class="input-field" placeholder="Pekerjaan ayah">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Ibu <span class="text-red-500">*</span></label>
                            <input type="text" name="nama_ibu" value="<?php echo e(old('nama_ibu')); ?>" required class="input-field" placeholder="Nama lengkap ibu">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Pekerjaan Ibu <span class="text-red-500">*</span></label>
                            <input type="text" name="pekerjaan_ibu" value="<?php echo e(old('pekerjaan_ibu')); ?>" required class="input-field" placeholder="Pekerjaan ibu">
                        </div>
                        
                        <div class="md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Nomor Telepon Orang Tua <span class="text-red-500">*</span></label>
                            <input type="tel" name="nomor_telepon_ortu" value="<?php echo e(old('nomor_telepon_ortu')); ?>" required class="input-field" placeholder="08xxxxxxxxxx">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="flex-1 bg-gray-200 text-gray-700 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-300 transition-all duration-300 text-center">
                        Batal
                    </a>
                </div>
            </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\sekolah-website\resources\views/pendaftaran/index.blade.php ENDPATH**/ ?>