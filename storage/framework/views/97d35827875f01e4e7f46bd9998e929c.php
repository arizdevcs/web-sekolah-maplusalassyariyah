...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MA Plus Al Asyariyah - Unggul dalam Prestasi'); ?></title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center flex-shrink-0">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3 hover:opacity-90 transition-opacity group">
            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route($item['route'])); ?>" 
                       data-active="<?php echo e(request()->routeIs($item['route']) ? 'true' : 'false'); ?>"
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                <a href="<?php echo e(route('pendaftaran.index')); ?>" class="hidden sm:inline-block px-5 py-2 rounded-lg font-bold text-sm transition-all duration-200 shadow-md hover:shadow-lg" :class="isScrolled ? 'bg-primary-600 text-white hover:bg-primary-700 hover:shadow-primary-200/50' : 'bg-white text-primary-700 hover:bg-primary-50'">
                    Pendaftaran
                </a>
    ...
    <div id="mobile-menu" x-show="open" x-transition:enter="transition transform origin-top duration-300" x-transition:enter-start="-translate-y-4 opacity-0" x-transition:enter-end="translate-y-0 opacity-100" x-transition:leave="transition transform origin-top duration-200" x-transition:leave-start="translate-y-0 opacity-100" x-transition:leave-end="-translate-y-4 opacity-0" @click.away="open = false" class="md:hidden fixed top-0 left-0 right-0 z-[90]" style="display:none;">
        <div class="w-full overflow-hidden pt-16 shadow-xl" :class="isScrolled ? 'bg-white' : 'bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800'">
            <div class="px-4 pt-2 pb-6 space-y-1">
                ...
                <a href="<?php echo e(route('pendaftaran.index')); ?>" class="block py-3 px-4 rounded-lg font-bold text-center mt-4 text-base transition-all duration-200 shadow-md" :class="isScrolled ? 'bg-primary-600 text-white hover:bg-primary-700 hover:shadow-lg' : 'bg-white text-primary-700 hover:bg-primary-50 hover:shadow-lg'">Daftar Sekarang</a>
            </div>
        </div>
    </div>
</nav>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?php echo e(route('home')); ?>" class="text-gray-400 hover:text-white text-sm transition">Beranda</a></li>
                    <li><a href="<?php echo e(route('about')); ?>" class="text-gray-400 hover:text-white text-sm transition">Profil</a></li>
                    <li><a href="<?php echo e(route('programs')); ?>" class="text-gray-400 hover:text-white text-sm transition">Program</a></li>
                </ul>
            </div>
        ...
        <div class="mt-8 pt-8 border-t border-green-800">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-gray-500 text-sm text-center md:text-left">
                    &copy; <?php echo e(date('Y')); ?> MA Plus Al Asy'ariyah
                </p>
               ...
               <?php /**PATH C:\sekolah-website\resources\views/layouts/app.blade.php ENDPATH**/ ?>