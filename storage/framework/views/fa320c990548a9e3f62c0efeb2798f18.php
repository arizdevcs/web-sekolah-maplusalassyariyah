<?php $__env->startSection('title', 'Cek Status Pendaftaran - MA Plus Al Asyariyah'); ?>
...
<section class="py-16 bg-gray-50 min-h-screen">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <form action="<?php echo e(route('pendaftaran.cek-status.submit')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
            ...
            <!-- Back Button -->
            <div class="mt-6">
                <a href="<?php echo e(route('home')); ?>" class="block text-center text-gray-600 hover:text-primary-600 font-medium transition-colors">
                    ← Kembali ke Beranda
                </a>
            </div>
        </div>
        ...
        <div class="mt-8 bg-gradient-to-br from-primary-50 to-primary-50 rounded-2xl p-8 border border-primary-100">
            ...
            <a href="<?php echo e(route('pendaftaran.index')); ?>" class="inline-block bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-lg font-semibold hover:from-primary-700 hover:to-primary-800 transition-all duration-300 shadow-lg">
                Daftar Sekarang →
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\sekolah-website\resources\views/pendaftaran/cek-status.blade.php ENDPATH**/ ?>